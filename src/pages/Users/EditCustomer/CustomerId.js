...
import { getCustomerProfileData, updateCustomerProfileData, uploadImages } from "../../../api/api";
...
export const CustomerId = () => {
    ...
    const fetchProfileData = async (formData) => {
        try {
            setLoading(true);
            const response = await getCustomerProfileData(formData.customerId);
    ...
    const updateCustomerProfileDatafun = async (payload,customerId) => {
        try {
            const response = await updateCustomerProfileData(payload, customerId);
            if (response && response.status==204) {
                ...
                fetchProfileData({...payload,customerId:customerId})
                                ...
                                <ListItem className="row">
                                    ...
                                    <div className="col-sm-3">
                                        <Button
                                            ...
                                            variant="contained"
                                            color="primary"
                                            disabled={!(values.customerId && values.customerId > 0)}
                                        >
                                            Get Details
                                        </Button>
                                    </div>
              ...
              <div>
               <Formik
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                        ...
                        delete payload.is_mobileno;
                        delete payload.images;
                        delete payload.email_id;
                        delete payload.customerId;

                        console.log(payload, "payload");
                        updateCustomerProfileDatafun(payload,values.customerId);
                    }}
                ...
                >
                    {({
                        ...
                        >
                            ...
                            {enableSave && dropdownOptions && <div> <Fab
                                type="submit"
                                className="save_btn"
                                variant="extended"
                                color="primary"
