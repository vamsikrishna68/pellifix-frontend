...
export const smokingHabitsList = [
    { label: 'No', value: 'No' },
    { label: 'Yes', value: 'Yes' },
    { label: 'Occasionally', value: 'Occasionally' }
]

export const drinkingHabitsList = [
    { label: 'No', value: 'No' },
    { label: 'Yes', value: 'Yes' },
    { label: 'Social Drinking', value: 'Social Drinking' }
]
...
export const motherToungeList = [
    ...
    { value: "3", label: 'Awadhi' },
    { value: "4", label: 'Bengali' },
    { value: "5", label: 'Bhojpuri' },
    { value: "6", label: 'Brij' },
    { value: "7", label: 'Bihari' },
    { value: "53", label: 'Badaga' },
    { value: "8", label: 'Chatisgarhi' },
    { value: "9", label: 'Dogri' },
    { value: "10", label: 'English' },
    { value: "11", label: 'French' },
    { value: "12", label: 'Garhwali' },
    { value: "13", label: 'Garo' },
    { value: "14", label: 'Gujarati' },
    { value: "15", label: 'Haryanvi' },
    { value: "16", label: 'Himachali/Pahari' },
    { value: "17", label: 'Hindi' },
    { value: "18", label: 'Kanauji' },
    { value: "19", label: 'Kannada' },
    { value: "20", label: 'Kashmiri' },
    { value: "21", label: 'Khandesi' },
    { value: "22", label: 'Khasi' },
    { value: "23", label: 'Konkani' },
    { value: "24", label: 'Koshali' },
    { value: "25", label: 'Kumaoni' },
    { value: "26", label: 'Kutchi' },
    { value: "27", label: 'Lepcha' },
    { value: "28", label: 'Ladacki' },
    { value: "29", label: 'Magahi' },
    { value: "30", label: 'Maithili' },
    { value: "31", label: 'Malayalam' },
    { value: "32", label: 'Manipuri' },
    { value: "33", label: 'Marathi' },
    { value: "34", label: 'Marwari' },
    { value: "35", label: 'Miji' },
    { value: "36", label: 'Mizo' },
    { value: "37", label: 'Monpa' },
    { value: "38", label: 'Nicobarese' },
    { value: "39", label: 'Nepali' },
    { value: "40", label: 'Oriya' },
    { value: "41", label: 'Punjabi' },
    { value: "42", label: 'Rajasthani' },
    { value: "43", label: 'Sanskrit' },
    { value: "44", label: 'Santhali' },
    { value: "45", label: 'Sindhi' },
    { value: "46", label: 'Sourashtra' },
    { value: "47", label: 'Tamil' },
    { value: "48", label: 'Telugu' },
    { value: "49", label: 'Tripuri' },
    { value: "50", label: 'Tulu' },
    { value: "51", label: 'Urdu' },
    { value: "55", label: 'Bagri Rajasthani' },
    { value: "56", label: 'Dhundhari/Jaipuri' },
    { value: "57", label: 'Gujari/Gojari' },
    { value: "58", label: 'Harauti' },
    { value: "59", label: 'Lambadi' },
    { value: "60", label: 'Malvi' },
    { value: "61", label: 'Mewari' },
    { value: "62", label: 'Mewati/Ahirwati' },
    { value: "63", label: 'Nimadi' },
    { value: "64", label: 'Shekhawati' },
    { value: "65", label: 'Wagdi' },

]

export const nakshtramList = [
    ...
    { label: 'Purva Phalguni', value: '' },
    { label: 'Uttara Phalguni', value: '' },
    { label: 'Hasta', value: 'Hasta' },
    { label: 'Chitra', value: 'Chitra' },
    { label: 'Swati', value: 'Swati' },
    { label: 'Vishaka', value: 'Vishaka' },
    { label: 'Anurada', value: 'Anurada' },
    { label: 'Jyeshta', value: 'Jyeshta' },
    ...
    { label: 'Shatabhishak', value: 'Shatabhishak' },
...
export const raasilist = [
    { label: 'Aries (Mesha)', value: 'Aries (Mesha)' },
    { label: 'Taurus (Vrishabha)', value: 'Taurus (Vrishabha)' },
    { label: 'Gemini (Mithuna)', value: 'Gemini (Mithuna)' },
    { label: 'Cancer (Karka)', value: 'Cancer (Karka)' },
    { label: 'Leo (Singha)', value: 'Leo (Singha)' },
    { label: 'Virgo (Kanya)', value: 'Virgo (Kanya)' },
    { label: 'Libra (Tula)', value: 'Libra (Tula)' },
    { label: 'Scorpio (Vrushchika)', value: 'Scorpio (Vrushchika)' },
    { label: 'Sagittarius (Dhanu)', value: 'Sagittarius (Dhanu)' },
    { label: 'Capricorn (Makara)', value: 'Capricorn (Makara)' },
    { label: 'Aquarius (Kumbha)', value: 'Aquarius (Kumbha)' },
    { label: 'Pisces (Meena)', value: 'Pisces (Meena)' }
]
